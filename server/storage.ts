  ...
  try {
    ...
    await db.insert(promos).values([
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&h=400',
        active: true,
      },
      {
        id: 'promo-2',
        ...
        imageUrl: 'https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&h=400',
        active: true,
      },
      {
        id: 'promo-3',
        ...
        imageUrl: 'https://images.unsplash.com/photo-1596797038530-2c107229654b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&h=400',
        active: true,
      },
    ]);
    ...
    await db.insert(menuItems).values([
      ...
      },
      {
        ...
        description: { en: 'Traditional rice milk drink with cinnamon', es: 'Bebida tradicional de leche de arroz con canela' },
        price: 4.99,
        imageUrl: 'https://images.unsplash.com/photo-1544145945-f90425340c7e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=300',
        spiceLevel: 0,
        flavors: ['flavor-4'],
        category: 'Beverage',
        ingredients: ['rice', 'milk', 'cinnamon', 'sugar', 'vanilla'],
        rating: 4.4,
        emoji: '🥛',
        active: true,
      },
      {
        id: 'menu-8',
        name: { en: 'Agua Fresca de Tamarindo', es: 'Agua Fresca de Tamarindo' },
        description: { en: 'Refreshing tamarind water with lime', es: 'Agua refrescante de tamarindo con limón' },
        price: 3.99,
        imageUrl: 'https://images.unsplash.com/photo-1544145945-f90425340c7e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=400&h=300',
        spiceLevel: 0,
        flavors: ['flavor-5', 'flavor-6'],
        category: 'Beverage',
        ingredients: ['tamarind', 'water', 'lime', 'sugar'],
        rating: 4.2,
        emoji: '🧊',
        active: true,
      },
